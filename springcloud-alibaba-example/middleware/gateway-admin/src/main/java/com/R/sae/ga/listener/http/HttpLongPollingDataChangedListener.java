package com.R.sae.ga.listener.http;

import com.R.sae.ga.config.properties.HttpSyncProperties;
import com.R.sae.ga.constants.HttpConstants;
import com.R.sae.ga.enums.ConfigGroupEnum;
import com.R.sae.ga.enums.DataEventTypeEnum;
import com.R.sae.ga.listener.AbstractDataChangedListener;
import com.R.sae.ga.listener.ConfigDataCache;
...
import com.R.sae.ga.utils.ShenyuThreadFactory;
...
public class HttpLongPollingDataChangedListener extends AbstractDataChangedListener {
    ...
    private List<ConfigGroupEnum> compareChangedGroup(final HttpServletRequest request) {
        ...
        for (ConfigGroupEnum group : ConfigGroupEnum.values()) {
            ...
            if (params == null || params.length != 2) {
                throw new RuntimeException("group param invalid:" + request.getParameter(group.name()));
            }
    ...
    private void generateResponse(final HttpServletResponse response, final List<ConfigGroupEnum> changedGroups) {
        try {
            ...
            response.getWriter().println(GsonUtils.getInstance().toJson(new AdminResult(CommonErrorCode.SUCCESSFUL,
                    AdminResultMessage.SUCCESS, changedGroups)));
